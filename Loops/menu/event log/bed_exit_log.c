...
/**
  * @brief  Bed-exit log page. Displays all recorded events when
  * 		the bed alarm was enabled/disabled. From here the user
  * 		can scroll up and down through these events, can clear
...
void bed_exit_log(){
	...
	draw(0,0,buffer,transparency,19);
