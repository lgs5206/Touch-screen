...
/**
  * @brief  System zero page. Displays the check list of criteria that need to be
  * 		met before the system can be completely zeroed. User can press next to
  * 		continue, or back to go back to the menu page.
  * @param	None
  * @retval None
  */
void sys_zero_loop() {
	...
	while (1) {
		...
		if (TS_State.touchDetected) {
			...
			/* If next button is pressed, warn user not to touch weighing surface, then zero the system */
